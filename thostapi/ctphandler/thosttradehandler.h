...
#ifndef INC_CTPTRADERHANDLER_H
#define INC_CTPTRADERHANDLER_H
...
class CThostTraderHandler : public CThostTraderApi, CThostFtdcTraderSpi {
public:
	CThostTraderHandler();

	CThostTraderHandler(string InvestorId, string Password, string BrokerId, string FrontAddress, string FlowPath, string UserProductInfo);
